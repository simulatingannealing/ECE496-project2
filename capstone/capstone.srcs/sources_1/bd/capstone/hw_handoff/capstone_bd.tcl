...
################################################################
# This is a generated script based on design: capstone
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: PS_to_PL, and set properties
  set PS_to_PL [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 PS_to_PL ]
  ...
  # Create instance: ffshark, and set properties
  set ffshark [ create_bd_cell -type ip -vlnv Marco_Merlini:fpga_bpf:axistream_packetfilt:1.0 ffshark ]
  set_property -dict [ list \
   CONFIG.ENABLE_BACKPRESSURE {1} \
   CONFIG.SN_FWD_DATA_WIDTH {32} \
 ] $ffshark

  # Create instance: input_0, and set properties
  set input_0 [ create_bd_cell -type ip -vlnv user.org:user:input:1.0 input_0 ]

  # Create instance: packet_output, and set properties
  set packet_output [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_fifo_mm_s:4.2 packet_output ]
  set_property -dict [ list \
  ...
  set ps [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.2 ps ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net PS_to_PL_M00_AXI [get_bd_intf_pins PS_to_PL/M00_AXI] [get_bd_intf_pins ffshark/s_axi]
  connect_bd_intf_net -intf_net PS_to_PL_M01_AXI [get_bd_intf_pins PS_to_PL/M01_AXI] [get_bd_intf_pins packet_output/S_AXI]
  connect_bd_intf_net -intf_net PS_to_PL_M02_AXI [get_bd_intf_pins PS_to_PL/M02_AXI] [get_bd_intf_pins debug_bridge_0/S_AXI]
  connect_bd_intf_net -intf_net ffshark_cb [get_bd_intf_pins ffshark/cb] [get_bd_intf_pins packet_output/AXI_STR_RXD]
connect_bd_intf_net -intf_net [get_bd_intf_nets ffshark_cb] [get_bd_intf_pins packet_output/AXI_STR_RXD] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  connect_bd_intf_net -intf_net input_packets_0_M00_AXIS [get_bd_intf_pins ffshark/sn] [get_bd_intf_pins input_0/M00_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets input_packets_0_M00_AXIS] [get_bd_intf_pins input_0/M00_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net ps_M_AXI_HPM0_FPD [get_bd_intf_pins PS_to_PL/S00_AXI] [get_bd_intf_pins ps/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net ffshark_control_start_debug [get_bd_pins ffshark/control_start_debug] [get_bd_pins input_0/input_enable_ffshark]
  connect_bd_net -net ps_pl_clk0 [get_bd_pins PS_to_PL/aclk] [get_bd_pins debug_bridge_0/s_axi_aclk] [get_bd_pins ffshark/clk] [get_bd_pins input_0/m00_axis_aclk] [get_bd_pins packet_output/s_axi_aclk] [get_bd_pins ps/maxihpm0_fpd_aclk] [get_bd_pins ps/pl_clk0] [get_bd_pins ps/saxihp0_fpd_aclk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net rst_ps_99M_peripheral_aresetn [get_bd_pins debug_bridge_0/s_axi_aresetn] [get_bd_pins ffshark/rst] [get_bd_pins input_0/m00_axis_aresetn] [get_bd_pins packet_output/s_axi_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins zero/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces ps/Data] [get_bd_addr_segs debug_bridge_0/S_AXI/Reg0] SEG_debug_bridge_0_Reg0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0010000 [get_bd_addr_spaces ps/Data] [get_bd_addr_segs ffshark/s_axi/reg0] SEG_ffshark_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0011000 [get_bd_addr_spaces ps/Data] [get_bd_addr_segs packet_output/S_AXI/Mem0] SEG_packet_output_Mem0
