...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_input_v1_0_M00_AXIS is
  ...
  signal reset_internal_i_1_n_0 : STD_LOGIC;
  ...
  signal \stream_data_out_reg[0]_i_2_n_7\ : STD_LOGIC;
  ...
  signal \NLW_stream_data_out_reg[0]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 2 );
  signal \NLW_stream_data_out_reg[0]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_mst_exec_state[1]_i_1\ : label is "soft_lutpair1";
...
reset_internal_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => reset_internal,
      I1 => input_enable_ffshark,
      O => reset_internal_i_1_n_0
    );
reset_internal_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => m00_axis_aclk,
      CE => '1',
      D => reset_internal_i_1_n_0,
      Q => reset_internal,
      R => '0'
    );
\reset_internal_reg__0\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\stream_data_out[0]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\stream_data_out[0]_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\stream_data_out[0]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\stream_data_out_reg[0]_i_2\: unisim.vcomponents.CARRY8
     port map (
      CI => '1',
      CI_TOP => '0',
      CO(7 downto 2) => \NLW_stream_data_out_reg[0]_i_2_CO_UNCONNECTED\(7 downto 2),
      CO(1) => axis_tvalid0,
      CO(0) => \stream_data_out_reg[0]_i_2_n_7\,
      DI(7 downto 1) => B"0000000",
      DI(0) => \stream_data_out[0]_i_3_n_0\,
      O(7 downto 0) => \NLW_stream_data_out_reg[0]_i_2_O_UNCONNECTED\(7 downto 0),
      S(7 downto 2) => B"000000",
      S(1) => \stream_data_out[0]_i_4_n_0\,
      S(0) => \stream_data_out[0]_i_5_n_0\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
