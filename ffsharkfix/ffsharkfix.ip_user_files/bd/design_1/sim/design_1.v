...
module design_1
  ...
  wire axistream_packetfilt_0_control_start_debug;
  wire axistream_packetfilt_0_sn_bp_TREADY;
  wire [31:0]input_0_m00_axis_tdata;
  wire input_0_m00_axis_tlast;
  wire [3:0]input_0_m00_axis_tstrb;
  wire input_0_m00_axis_tvalid;
  wire [0:0]one_dout;
  ...
  design_1_axistream_packetfilt_0_0 axistream_packetfilt_0
       (.cb_TDATA(axistream_packetfilt_0_cb_TDATA),
        ...
        .control_start_debug(axistream_packetfilt_0_control_start_debug),
        .rst(zero_dout),
        ...
        .sn_TDATA(input_0_m00_axis_tdata),
        .sn_TKEEP(input_0_m00_axis_tstrb),
        .sn_TLAST(input_0_m00_axis_tlast),
        .sn_TREADY(1'b1),
        .sn_TVALID(input_0_m00_axis_tvalid),
  ...
  design_1_debug_bridge_0_0 debug_bridge_0
       (.S_AXI_araddr(smartconnect_0_M02_AXI_ARADDR[4:0]),
        ...
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .s_axi_aresetn(one_dout));
  design_1_input_0_0 input_0
       (.input_enable_ffshark(axistream_packetfilt_0_control_start_debug),
        .m00_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .m00_axis_aresetn(one_dout),
        .m00_axis_tdata(input_0_m00_axis_tdata),
        .m00_axis_tlast(input_0_m00_axis_tlast),
        .m00_axis_tready(axistream_packetfilt_0_sn_bp_TREADY),
        .m00_axis_tstrb(input_0_m00_axis_tstrb),
        .m00_axis_tvalid(input_0_m00_axis_tvalid));
