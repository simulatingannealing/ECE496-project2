...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_RX_FIFO_PF_THRESHOLD {1019} \
  ...
  # Create instance: axistream_packetfilt_0, and set properties
  set axistream_packetfilt_0 [ create_bd_cell -type ip -vlnv Marco_Merlini:fpga_bpf:axistream_packetfilt:1.0 axistream_packetfilt_0 ]
  set_property -dict [ list \
   CONFIG.BUF_IN {1} \
   CONFIG.BUF_OUT {1} \
   CONFIG.ENABLE_BACKPRESSURE {1} \
   CONFIG.SN_FWD_DATA_WIDTH {32} \
 ] $axistream_packetfilt_0
  ...
  connect_bd_intf_net -intf_net axistream_packetfilt_0_cb [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_RXD] [get_bd_intf_pins axistream_packetfilt_0/cb]
connect_bd_intf_net -intf_net [get_bd_intf_nets axistream_packetfilt_0_cb] [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_RXD] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins axistream_packetfilt_0/s_axi] [get_bd_intf_pins smartconnect_0/M00_AXI]
  ...
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_txd_tdata [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tdata] [get_bd_pins axistream_packetfilt_0/sn_TDATA] [get_bd_pins system_ila_0/SLOT_0_AXIS_tdata]
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_txd_tkeep [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tkeep] [get_bd_pins axistream_packetfilt_0/sn_TKEEP] [get_bd_pins system_ila_0/SLOT_0_AXIS_tstrb]
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_txd_tlast [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tlast] [get_bd_pins axistream_packetfilt_0/sn_TLAST] [get_bd_pins system_ila_0/SLOT_0_AXIS_tlast]
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_txd_tvalid [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tvalid] [get_bd_pins axistream_packetfilt_0/sn_TVALID] [get_bd_pins system_ila_0/SLOT_0_AXIS_tvalid]
  connect_bd_net -net axistream_packetfilt_0_sn_bp_TREADY [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tready] [get_bd_pins axistream_packetfilt_0/sn_bp_TREADY] [get_bd_pins system_ila_0/SLOT_0_AXIS_tready]
  connect_bd_net -net one_dout [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins debug_bridge_0/s_axi_aresetn] [get_bd_pins one/dout] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net zero_dout [get_bd_pins axistream_packetfilt_0/rst] [get_bd_pins zero/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins axistream_packetfilt_0/clk] [get_bd_pins debug_bridge_0/s_axi_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0xA0011000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_fifo_mm_s_0/S_AXI/Mem0] SEG_axi_fifo_mm_s_0_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axistream_packetfilt_0/s_axi/reg0] SEG_axistream_packetfilt_0_reg0
